...
$host = "localhost";
  ...
  //I used various conditions and JOIN to retrieve the required data from both tables
  ...
  //I used a loop function to output each line of data onto the screen
